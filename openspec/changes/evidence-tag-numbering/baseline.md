...
══════════════════════════════════════════════════════════════════════════════
 ...
 6. [OBS-013: transcript-event-log-extraction/whiteboard.md:169-175]
...
══════════════════════════════════════════════════════════════════════════════
 ...
 1. [OBS-014: evidence-tag-numbering/whiteboard.md:17-25]
    Glossary definitions use escaped brackets, no numbering:
    | **\[O\]** | **Observed** — ...
    | **\[M\]** | **Measured** — ...

 2. [OBS-015: evidence-tag-numbering/whiteboard.md:47]
    Body tag hand-numbered with escaped brackets + block anchor:
    **\[OBS-001\]** Evidence tags appear in 3 distinct... ^O-001

 3. [OBS-016: evidence-tag-numbering/whiteboard.md:85]
    Ideal bucket tag hand-numbered:
    **\[A-001\]** After running the script... ^A-001

 4. [OBS-017: evidence-tag-numbering/whiteboard.md:104-108]
...
##### **\[F-LK-001\]** Tags originate as unstructured LLM output — no format enforcement exists
...
- [OBS-010 through O-013: llm creates evidence tags during artifact authoring](#TRACE%20LLM%20creates%20evidence%20tags%20during%20artifact%20authoring%20(opsx%20continue))— Trace 1 steps 3-6
- [M-002](#**%5CM-002%5C]**%20Tag%20distribution%20in%20transcript%20whiteboard) — 43 tags, 7 types, zero formatting

##### **\[F-LK-002\]** Body tags appear in two positions — line-start and mid-line
...
- [OBS-012](#TRACE%20LLM%20creates%20evidence%20tags%20during%20artifact%20authoring%20(opsxcontinue)) — Trace 1 step 5, mid-line tags in list items
...
##### **\[F-LK-003\]** Zero consistency in bracket escaping across existing artifacts
...
##### **\[F-ID-004\]** The target format has three distinct tag treatments
...
- [OBS-014](#TRACE:%20Human%20hand-numbers%20tags%20in%20evidence-tag-numbering%20whiteboard) — Trace 2 step 1, glossary format
- [OBS-015](#TRACE:%20Human%20hand-numbers%20tags%20in%20evidence-tag-numbering%20whiteboard) — Trace 2 step 2, body format with anchor

##### **\[F-LK-005\]** Citation-manager already integrates `marked` for AST parsing
...
##### **\[F-LK-006\]** No lines in any existing artifact contain multiple bold-wrapped tags on the same line
...
- [OBS-012](#TRACE:%20LLM%20creates%20evidence%20tags%20during%20artifact%20authoring) — mid-line tags are single per line
