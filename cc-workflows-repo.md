...
**Status**: ✅ **RESOLVED** (2025-10-05 via [US1.4b](user-stories/us1.4b-refactor-components-for-di/us1.4b-refactor-components-for-di.md))

**Resolution Summary**:
- **Phase 1**: Refactored CitationValidator, MarkdownParser, FileCache for constructor DI (Task 1.1)
- **Phase 2**: Implemented factory pattern at `src/factories/componentFactory.js` (Task 2.1)
- **Phase 3**: Updated CLI to use factory functions (Task 3.1)
- **Phase 4**: Updated all tests to use factory pattern with real dependencies (Tasks 4.1-4.5)
- **Evidence**: All 50+ tests passing, including new component integration tests validating real system collaboration

**Factory Pattern Implementation**:
- Location: `tools/citation-manager/src/factories/componentFactory.js`
- Exports: `createCitationValidator()`, `createMarkdownParser()`, `createFileCache()`
- Pattern: Optional parameter injection for shared instances, defaults to internal creation
