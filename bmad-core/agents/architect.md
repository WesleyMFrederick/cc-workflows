...
activation-instructions:
  ...
  - STEP 0 (WHEN CREATING OUTPUT): FIRST load `.bmad-core/core-config.yaml` and extract `paths.outputBase` and `paths.featurePrefix` for output file path construction
