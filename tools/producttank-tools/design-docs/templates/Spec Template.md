...
<project_specification>
  ...
  <key_interactions>
    ...
    <artifact_flow>
      10. Assistant generates artifact in response
      11. Artifact panel slides in from right
      12. Content renders (code with highlighting or live preview)
      13. User can edit artifact inline
      14. "Re-prompt" button to iterate with Claude
      15. Download or copy artifact content
      16. Full-screen mode for detailed work
      17. Close panel to return to chat focus
    </artifact_flow>

    <conversation_management>
      18. Click "New Chat" to start fresh conversation
      19. Conversations auto-save with first message
      20. Auto-generate title from first exchange
      21. Click title to rename inline
      22. Drag conversations into folders
      23. Right-click for context menu (pin, archive, delete, export)
      24. Search filters conversations in real-time
      25. Click conversation to switch context
    </conversation_management>
  </key_interactions>
