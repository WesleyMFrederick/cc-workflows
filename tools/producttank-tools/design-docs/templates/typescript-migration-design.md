...
**Validation**: Matches [CitationValidator Component Guide - Output Contract](<../../../component-guides/CitationValidator Implementation Guide.md#Output Contract>)
...
**Reference**: [Markdown Parser Data Contracts](<../../../component-guides/Markdown Parser Implementation Guide.md#Data Contracts>)
...
**Reference**: [CitationValidator Output Contract](<../../../component-guides/CitationValidator Implementation Guide.md#Output Contract>)
...
**Reference**: [Content Extractor Data Contracts](<../../../component-guides/Content Extractor Implementation Guide.md>)
...
- **MarkdownParser Guide**: [Markdown Parser Implementation Guide](<../../../component-guides/Markdown Parser Implementation Guide.md>)
- **CitationValidator Guide**: [CitationValidator Implementation Guide](<../../../component-guides/CitationValidator Implementation Guide.md>)
- **ContentExtractor Guide**: [Content Extractor Implementation Guide](<../../../component-guides/Content Extractor Implementation Guide.md>)

### Architecture Standards

- **Architecture Principles**: [ARCHITECTURE-PRINCIPLES.md](../../../../../../ARCHITECTURE-PRINCIPLES.md) - 9 principle categories
- **Development Workflow**: [Development Workflow.md](<../0-elicit-sense-making-phase/Development Workflow.md>) - Progressive disclosure process
