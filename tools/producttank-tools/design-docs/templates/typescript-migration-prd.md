...
- **Rollback Plan**: [Next Steps After Rollback](<../0-elicit-sense-making-phase/ROLLBACK-PLAN.md#Next Steps After Rollback>) - Fresh migration strategy
...
- **Development Workflow Quick Reference**: [Development Workflow Quick Reference](<../../../../../../claude/skills/enforcing-development-workflow/Development Workflow Quick Reference.md>)%% force-extract%%

### Architecture Standards

- **Data-First Design**: [ARCHITECTURE-PRINCIPLES.md](<../../../../../../ARCHITECTURE-PRINCIPLES.md#Data-First Design Principles>) - Foundation of contract preservation
- **Modular Design**: [ARCHITECTURE-PRINCIPLES.md](<../../../../../../ARCHITECTURE-PRINCIPLES.md#Modular Design Principles>) - Component boundary principles
- **Safety-First Patterns**: [ARCHITECTURE-PRINCIPLES.md](<../../../../../../ARCHITECTURE-PRINCIPLES.md#Safety-First Design Patterns>) - Validation and error handling

### Process Documentation

- **Development Workflow**: [Development Workflow.md](<../Development Workflow.md#Progressive Disclosure: Four Levels>) - Progressive disclosure from requirements to implementation
