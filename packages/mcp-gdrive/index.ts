...
import type { InternalToolResponse } from "./tools/types.js";
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
	...
	// biome-ignore lint/suspicious/noExplicitAny: MCP SDK provides untyped arguments, each tool validates internally
